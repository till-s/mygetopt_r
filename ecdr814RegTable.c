...
static EcNodeRec ad6620RawRegDefs[] = {
	...
	/* 						start,end		value		*/
{	"mcr",		EcAD6620Reg,	0x1800,	REGUNION( 0, 32, 	0,	1)		},	/* leave in reset */
{	"ncoCtl",	EcAD6620Reg,	0x1808,	REGUNION( 0, 32, 	0,	0)		},
...
{	"cic2Decm",	EcAD6620Reg,	0x1830,	REGUNION( 0, 32, 	0,	0)		},
{	"cic5Scale",	EcAD6620Reg,	0x1838,	REGUNION( 0, 32, 	0,	0)		},
{	"cic5Decm",	EcAD6620Reg,	0x1840,	REGUNION( 0, 32, 	0,	0)		},
{	"rcfCtl",	EcAD6620Reg,	0x1848,	REGUNION( 0, 32, 	0,	0)		},
{	"rcfDecm",	EcAD6620Reg,	0x1850,	REGUNION( 0, 32, 	0,	0)		},
{	"rcf1stTap",	EcAD6620Reg,	0x1858,	REGUNION( 0, 32, 	0,	0)		},
{	"rcfNTaps",	EcAD6620Reg,	0x1860,	REGUNION( 0, 32, 	0,	0)		},
};

static EcNodeRec ad6620RegDefs[] = {
	/* name,	node type,	offset,		bitmask	 	flags	initialization	*/
	/* 						start,end		value		*/
{	"reset",	EcAD6620Reg,	0x1800,	REGUNION( 0, 1,		0,	1)		},	/* leave in reset; TODO they hold it in reset state while programming anything in the AD6620 */
{	"realcmplx",	EcAD6620Reg,	0x1800,	REGUNION( 1, 3,		0,	2)		},	/* TODO: special combination - single chan, cmplx */
{	"syncMaster",	EcAD6620Reg,	0x1800,	REGUNION( 3, 8,		0,	0)		},	/* single chan, cmplx, should not set, 4-7 must be written low */
{	"ncoBypass",	EcAD6620Reg,	0x1808,	REGUNION( 0, 1,		0,	0)		},	/* off */
{	"phaseDith",	EcAD6620Reg,	0x1808,	REGUNION( 1, 2,		0,	0)		},	/* off */
{	"ampDith",	EcAD6620Reg,	0x1808,	REGUNION( 2, 3,		0,	0)		},	/* off */
{	"ncoSyncMsk",	EcAD6620Reg,	0x1810,	REGUNION( 0, 32,	0,	0)		},
{	"ncoFreq",	EcAD6620Reg,	0x1818,	REGUNION( 0, 32,	0,	0)		},
{	"ncoPhase",	EcAD6620Reg,	0x1820,	REGUNION( 0, 32,	0,	0)		},
...
{	"cic2Decm",	EcAD6620Reg,	0x1830,	REGUNION( 0, 8,		0,	0)		},	/* TODO n-1 */
{	"cic5Scale",	EcAD6620Reg,	0x1838,	REGUNION( 0, 5,		0,	0)		},	/* TODO LR 0..20 */
{	"cic5Decm",	EcAD6620Reg,	0x1840,	REGUNION( 0, 8,		0,	0)		},	/* TODO n-1, should be less than 31 */
{	"rcfScale",	EcAD6620Reg,	0x1848,	REGUNION( 0, 8,		0,	0)		},	/* TODO: formula, bit 3-7 must be written 0 */
{	"rcfDecm",	EcAD6620Reg,	0x1850,	REGUNION( 0, 8,		0,	0)		},	/* TODO: range check, limitation (speed) should be less than 32 */
{	"rcf1stTap",	EcAD6620Reg,	0x1858,	REGUNION( 0, 8,		0,	0)		},	/* TODO: range check: wraparound? */
{	"rcfNTaps",	EcAD6620Reg,	0x1860,	REGUNION( 0, 8,		0,	0)		},	/* TODO: range check: wraparound? */
};
...
{	"syncEna",	EcReg,		0x0,	REGUNION( 1, 2,		0,	0)		},	/* TODO: use with gateEna all syncs work */
{	"gateEna",	EcReg,		0x0,	REGUNION( 2, 3,		0,	0)		},	/* TODO: disable freerun & swsync */
{	"freeRun",	EcReg,		0x0,	REGUNION( 3, 4,		0,	0)		},
{	"counterEna",	EcReg,		0x0,	REGUNION( 4, 5,		0,	0)		},
{	"dualRxPara",	EcReg,		0x0,	REGUNION( 5, 6,		0,	0)		},
{	"trigClear",	EcReg,		0x0,	REGUNION( 15, 16,	0,	0)		},
{	"modeSelect",	EcReg,		0x4,	REGUNION( 0, 3,		0,	0)		},	/* raw AD */
...
{	"fifoFlgOff",	EcReg,		0x0,	REGUNION( 2, 4,		0,	0)		},	/* TODO related to offset, same for all channels ; depends on rdbackMode */
{	"fifoUseOff",	EcReg,		0x0,	REGUNION( 4, 5,		0,	0)		},	/* TODO */
...
{	"rdbackMode",	EcReg,		0x0,	REGUNION( 0, 4,		0,	0)		},	/* LR, affects fifoFlags (if !offset): 1chan: OFFSET_16, 2 channels: OFFSET 8, 4 channels: OFFSET 4, 8channels: OFFSET 2, unused channels get their syncEna and gateEna cleared  pair uses 01.0 and 23.0, 4 channels uses 01.0, 23.0, 45.0, 67.0 */
{	"headerEna",	EcReg,		0x0,	REGUNION( 4, 5,		0,	0)		},
{	"vmeOnly",	EcReg,		0x0,	REGUNION( 5, 6,		0,	0)		},
{	"d64_2kEna",	EcReg,		0x0,	REGUNION( 6, 7,		0,	0)		},
{	"freqRange",	EcReg,		0x0,	REGUNION( 7, 9,		0,	0)		},	/* unusual ordering */
...
{	"clkMult0_3",	EcReg,		0x0,	REGUNION( 17, 19,	0,	0)		},	/* TODO unusual ordering, wait 15ms */
{	"clkMult4_7",	EcReg,		0x0,	REGUNION( 19, 21,	0,	0)		},	/* TODO unusual ordering, wait 15ms */
{	"fifo0Stat",	EcReg,		0x4,	REGUNION( 0, 4,		RO,	0)		},	/* TODO LR */
{	"fifo1Stat",	EcReg,		0x4,	REGUNION( 4, 8,		RO,	0)		},	/* TODO LR */
{	"fifo2Stat",	EcReg,		0x4,	REGUNION( 8, 12,	RO,	0)		},	/* TODO LR */
{	"fifo3Stat",	EcReg,		0x4,	REGUNION( 12, 16,	RO,	0)		},	/* TODO LR */
{	"fifo4Stat",	EcReg,		0x4,	REGUNION( 16, 20,	RO,	0)		},	/* TODO LR */
{	"fifo5Stat",	EcReg,		0x4,	REGUNION( 20, 24,	RO,	0)		},	/* TODO LR */
{	"fifo6Stat",	EcReg,		0x4,	REGUNION( 24, 28,	RO,	0)		},	/* TODO LR */
{	"fifo7Stat",	EcReg,		0x4,	REGUNION( 28, 32,	RO,	0)		},	/* TODO LR */
{	"intVec",	EcReg,		0x8,	REGUNION( 0, 8,		0,	0)		},
{	"intCh0Msk",	EcReg,		0xc,	REGUNION( 0, 1,		0,	0)		},
{	"intCh1Msk",	EcReg,		0xc,	REGUNION( 1, 2,		0,	0)		},
{	"intCh2Msk",	EcReg,		0xc,	REGUNION( 2, 3,		0,	0)		},
{	"intCh3Msk",	EcReg,		0xc,	REGUNION( 3, 4,		0,	0)		},
{	"intCh4Msk",	EcReg,		0xc,	REGUNION( 4, 5,		0,	0)		},
{	"intCh5Msk",	EcReg,		0xc,	REGUNION( 5, 6,		0,	0)		},
{	"intCh6Msk",	EcReg,		0xc,	REGUNION( 6, 7,		0,	0)		},
{	"intCh7Msk",	EcReg,		0xc,	REGUNION( 7, 8,		0,	0)		},
{	"intCh7Msk",	EcReg,		0xc,	REGUNION( 7, 8,		0,	0)		},
{	"rwyTimMsk",	EcReg,		0xc,	REGUNION( 8, 9,		0,	0)		},
{	"rwyAMsk",	EcReg,		0xc,	REGUNION( 9, 10,	0,	0)		},
{	"rwyBMsk",	EcReg,		0xc,	REGUNION( 10, 11,	0,	0)		},
{	"intCh0Stat",	EcReg,		0x10,	REGUNION( 0, 1,		RO,	0)		},
{	"intCh1Stat",	EcReg,		0x10,	REGUNION( 1, 2,		RO,	0)		},
{	"intCh2Stat",	EcReg,		0x10,	REGUNION( 2, 3,		RO,	0)		},
{	"intCh3Stat",	EcReg,		0x10,	REGUNION( 3, 4,		RO,	0)		},
{	"intCh4Stat",	EcReg,		0x10,	REGUNION( 4, 5,		RO,	0)		},
{	"intCh5Stat",	EcReg,		0x10,	REGUNION( 5, 6,		RO,	0)		},
{	"intCh6Stat",	EcReg,		0x10,	REGUNION( 6, 7,		RO,	0)		},
{	"intCh7Stat",	EcReg,		0x10,	REGUNION( 7, 8,		RO,	0)		},
...
{	"ch0OvrRng",	EcReg,		0x14,	REGUNION( 24, 25,	RO,	0)		},
{	"ch1OvrRng",	EcReg,		0x14,	REGUNION( 25, 26,	RO,	0)		},
{	"ch2OvrRng",	EcReg,		0x14,	REGUNION( 26, 27,	RO,	0)		},
{	"ch3OvrRng",	EcReg,		0x14,	REGUNION( 27, 28,	RO,	0)		},
{	"ch4OvrRng",	EcReg,		0x14,	REGUNION( 28, 29,	RO,	0)		},
{	"ch5OvrRng",	EcReg,		0x14,	REGUNION( 29, 30,	RO,	0)		},
{	"ch6OvrRng",	EcReg,		0x14,	REGUNION( 30, 31,	RO,	0)		},
{	"ch7OvrRng",	EcReg,		0x14,	REGUNION( 31, 32,	RO,	0)		},
{	"extHdr",	EcReg,		0x18,	REGUNION( 0, 16,	RO,	0)		},
{	"ch0FifoOfl",	EcReg,		0x18,	REGUNION( 16, 17,	RO,	0)		},
{	"ch1FifoOfl",	EcReg,		0x18,	REGUNION( 17, 18,	RO,	0)		},
{	"ch2FifoOfl",	EcReg,		0x18,	REGUNION( 18, 19,	RO,	0)		},
{	"ch3FifoOfl",	EcReg,		0x18,	REGUNION( 19, 20,	RO,	0)		},
{	"ch4FifoOfl",	EcReg,		0x18,	REGUNION( 20, 21,	RO,	0)		},
{	"ch5FifoOfl",	EcReg,		0x18,	REGUNION( 21, 22,	RO,	0)		},
{	"ch6FifoOfl",	EcReg,		0x18,	REGUNION( 22, 23,	RO,	0)		},
{	"ch7FifoOfl",	EcReg,		0x18,	REGUNION( 23, 24,	RO,	0)		},
{	"ch0FifoUfl",	EcReg,		0x18,	REGUNION( 24, 25,	RO,	0)		},
{	"ch1FifoUfl",	EcReg,		0x18,	REGUNION( 25, 26,	RO,	0)		},
{	"ch2FifoUfl",	EcReg,		0x18,	REGUNION( 26, 27,	RO,	0)		},
{	"ch3FifoUfl",	EcReg,		0x18,	REGUNION( 27, 28,	RO,	0)		},
{	"ch4FifoUfl",	EcReg,		0x18,	REGUNION( 28, 29,	RO,	0)		},
{	"ch5FifoUfl",	EcReg,		0x18,	REGUNION( 29, 30,	RO,	0)		},
{	"ch6FifoUfl",	EcReg,		0x18,	REGUNION( 30, 31,	RO,	0)		},
{	"ch7FifoUfl",	EcReg,		0x18,	REGUNION( 31, 32,	RO,	0)		},
